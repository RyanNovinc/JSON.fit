...
End with: "Review complete. When you're happy with this plan, type 'JSON' and I'll fetch the conversion prompt and convert your program for import into JSON.fit."
